        ...
        <div class="footer-section">
            ...
            <p>
                ...
                <a href="mailto:contact@osmoz.center" style="color: inherit; text-decoration: none;">
                    litsaetsesloulous@gmail.com
                </a>
            </p>
            <p>
                <ion-icon name="location-outline"></ion-icon>
                <a href="https://g.co/kgs/ACLFkrc" target="_blank" style="color: inherit; text-decoration: none;">
                    62 Rue Charles de Gaulle, 78350 Jouy-en-Josas
                </a>
            </p>
            <ul class="social-icon">
                ...
                <li class="social-icon__item">
                    <a class="social-icon__link" href="https://www.instagram.com/litsaetsesloulous/">
